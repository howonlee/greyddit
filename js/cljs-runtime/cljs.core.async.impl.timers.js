...
var i_15010 = (self__.level + (1));
while(true){
if((i_15010 <= (new_level + (1)))){
(update[i_15010] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_15014 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_15014[i]));
} else {
x__$2.forward.push((((i < links_15014.length))?(links_15014[i]):null));
}

if((i < links_15014.length)){
(links_15014[i] = x__$2);
} else {
links_15014.push(x__$2);
}
...
var i_15016 = (0);
while(true){
if((i_15016 <= self__.level)){
var links_15017 = (update[i_15016]).forward;
if((x__$1 === (((i_15016 < links_15017.length))?(links_15017[i_15016]):null))){
(links_15017[i_15016] = (x__$1.forward[i_15016]));

var G__15018 = (i_15016 + (1));
i_15016 = G__15018;
continue;
} else {
var G__15019 = (i_15016 + (1));
i_15016 = G__15019;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__15026 = nx;
var G__15027 = (level__$1 - (1));
x = G__15026;
level__$1 = G__15027;
continue;
} else {
var G__15028 = x;
var G__15029 = (level__$1 - (1));
x = G__15028;
level__$1 = G__15029;
continue;
}
