...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21892 = c;
var G__21892__$1 = (((G__21892 == null))?null:G__21892.prototype);
if((G__21892__$1 == null)){
return null;
} else {
return G__21892__$1.reagentRender;
}
})() == null)))));
});
...
var c = this;
var G__21908_21924 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21908_21924 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21908_21924);
}
...
var renders_21927 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21928 = cljs.core.first(cljs.core.vals(renders_21927));
...
if((cljs.core.count(renders_21927) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21927))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21928)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21928], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
while (G__21932__i < G__21932__a.length) {G__21932__a[G__21932__i] = arguments[G__21932__i + 0]; ++G__21932__i;}
  args = new cljs.core.IndexedSeq(G__21932__a,0,null);
} 
